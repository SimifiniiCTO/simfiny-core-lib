...
func (c *Client) RequestTimeUnaryServerInterceptor() grpc.UnaryServerInterceptor {
...
func (c *Client) RequestTimeStreamServerInterceptor() grpc.StreamServerInterceptor {
